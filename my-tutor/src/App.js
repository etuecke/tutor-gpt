  ...
  return (
    ...
    >
      <div style={{ padding: "20px", borderBottom: "1px solid #ccc" }}>
        ...
        <p>
          <strong class="blue">(1)</strong> Upload a PDF with your class notes
          or lecture notes to get started
        </p>
        {/* File upload input */}
      ...
      >
        ...
        <div style={{ width: "50%", padding: "20px" }}>
          <p>
            <strong class="blue">(2)</strong> Now, tell us what you need help
            with, what you understand so far, and what you are confused about.
          </p>
        ...
        >
          <label htmlFor="model-log" class="underline">
            TutorGPT Log:
          </label>
          <div
